...
public class Gameplay extends JPanel implements KeyListener, ActionListener {
	...
	public void paint(Graphics g) {
		...
		Image binaryMessageImage = toolkit.getImage("c:/Users/Strayer Family/eclipse-workspace/brickBreaker/src/brickBreaker/resources/hidden.jpg");
	...
	g.drawString(""+score, 590, 30 );	
		...
		if(ballposY > 570 ) {
			...
			g.drawString("GO FUCK YOURSELF, BEN Score: " +score, 50, 300);
